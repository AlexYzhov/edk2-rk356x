...
[PcdsFixedAtBuild.common]
  ...
  # serg GPIO1_PIN_PB2 - 10 / From E25
  #gRk356xTokenSpaceGuid.PcdPcieResetGpioBank|1
  #gRk356xTokenSpaceGuid.PcdPcieResetGpioPin|10 
  # reset-gpios = <&gpio0 RK_PB6 GPIO_ACTIVE_HIGH>; / R5S
  # PCIE20_CLKREQn_M2       / GPIO1_B0_d
  # PCIE20_WAKEn_M2         / GPIO1_B1_d
  # PCIE20_PERSTn_M2        / GPIO1_B2_d
  gRk356xTokenSpaceGuid.PcdPcieResetGpioBank|0
  gRk356xTokenSpaceGuid.PcdPcieResetGpioPin|14
  # serg GPIO_PIN_PA7 - 7 /From E25
  #gRk356xTokenSpaceGuid.PcdPciePowerGpioBank|3
  #gRk356xTokenSpaceGuid.PcdPciePowerGpioPin|7
  # gpio = <&gpio0 RK_PD4 GPIO_ACTIVE_HIGH>;  /R4S
...
!endif
  ...
  #Platform/FriendlyElec/Drivers/LogoDxe/LogoDxe.inf
